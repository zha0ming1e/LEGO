#ifndef LEGO_EDGEIMU_H
#define LEGO_EDGEIMU_H
...
namespace lego {
    ...
    public:
        ...
        void push_back(double deltaT, const Eigen::Vector3d &acc, const Eigen::Vector3d &gyr) {
            dt_buf.push_back(deltaT);
            acc_buf.push_back(acc);
            gyr_buf.push_back(gyr);

            propagate(deltaT, acc, gyr);
        }
     ...
     * EdgeIMU
     *
     * 4 vertexes connected to it: Pi, Mi, Pj, Mj
     */
    class EdgeIMU : public BaseEdge {
    public:
        ...
        std::string getInfo() const override { return "EdgeIMU"; }
